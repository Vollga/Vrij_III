...
public class DungeonControllerBasic : MonoBehaviour
{
    // Public variables
    [Header("Map Setup")]
    ...
    void InitialiseDungeon()
    {
        ...
        if (!drawBasic)
        {
            roomsList = DungeonSpawner.DrawLayout(dungeon, this.transform.position, sizemultiplier, this.transform, drawEmptyRooms, emptyTile);
        }
        else
        {
